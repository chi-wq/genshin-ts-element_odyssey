...
> 本文档记录 v0.03 → v0.04 的变更内容。
> `main` 已于 2026-06-24 合并 `add_ver0.04_features`，当前 `main` 为 v0.04。
> 以下 v0.03 的内容为合并前的原型状态，保留作为历史参考。
>
> 生成日期: 2026-06-24

---

# 第一部分: v0.03 原型（合并前 main）
...
# 第二部分: v0.04 新增内容（原 add_ver0.04_features）
